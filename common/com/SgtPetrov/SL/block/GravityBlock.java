...
public class GravityBlock extends BlockSL {
    /** Do blocks fall instantly to where they stop or do they fall over time */
    public static boolean fallInstantly = false;

    public GravityBlock(int par1) {
        super(par1, Material.cloth);
        
        this.setUnlocalizedName(Strings.GRAVITY_BLOCK_NAME);
    }
     ...
     */
    protected void tryToFall(World par1World, int par2, int par3, int par4)
    {
